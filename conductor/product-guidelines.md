...
## Prose Style
- **Clarity First:** Avoid technical jargon in the user output (Markdown table).
- **Direct Tone:** Use concise and informative labels for data columns.
- **Informative Errors:** If a fetch fails, provide a clear reason (e.g., "Network error" or "No results found").
